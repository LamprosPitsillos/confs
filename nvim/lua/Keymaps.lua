...
M.imap("<C-k>", "<cmd>wincmd k<cr>", { desc = "up" })
M.imap("<C-l>", "<cmd>wincmd l<cr>", { desc = "right" })
M.imap("<C-j>", "<cmd>wincmd j<cr>", { desc = "down" })
M.imap("<C-h>", "<cmd>wincmd h<cr>", { desc = "left" })
M.imap("<C-Up>", "<cmd>2wincmd +<cr>", { desc = "increase" })
M.imap("<C-Right>", "<cmd>2wincmd ><cr>", { desc = "right" })
M.imap("<C-Left>", "<cmd>2wincmd <<cr>", { desc = "left" })
M.imap("<C-Down>", "<cmd>2wincmd -<cr>", { desc = "decrease" })
M.nmap("<C-l>", "<cmd>wincmd l<cr>", { desc = "right" })
M.nmap("<C-k>", "<cmd>wincmd k<cr>", { desc = "up" })
M.nmap("<C-j>", "<cmd>wincmd j<cr>", { desc = "down" })
M.nmap("<C-h>", "<cmd>wincmd h<cr>", { desc = "left" })
M.nmap("<C-Up>", "<cmd>2wincmd +<cr>", { desc = "increase" })
M.nmap("<C-Right>", "<cmd>2wincmd ><cr>", { desc = "right" })
M.nmap("<C-Left>", "<cmd>2wincmd <<cr>", { desc = "left" })
M.nmap("<C-Down>", "<cmd>2wincmd -<cr>", { desc = "decrease" })
...
M.nmap("yY", "^y$", {})
M.nmap("dD", "^d$", {})
M.vmap("<C-k>", ":m '<-2<CR>gv=gv", {})
M.vmap("<C-j>", ":m '>+1<CR>gv=gv", {})
